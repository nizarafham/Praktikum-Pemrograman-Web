    ...
    <script>
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                console.log('Detail error:', xhr.responseJSON);

                if (xhr.responseJSON) {
                    alert('Error: ' + xhr.responseJSON.message || 'Login gagal');
                } else {
        ...
        function logout() {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    if (xhr.responseJSON) {
                        alert('Error saat logout: ' + xhr.responseJSON.message || 'Coba lagi nanti.');
                    } else {
